        ...
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
            ...
            <p className="my-7 flex flex-wrap gap-2">
              ...
              <div className="flex items-center">
                  ...
                  <span className="text-sm  text-gray-900  hover:no-underline dark:text-white">{movie.vote_count} Reviews</span>
              </div>
              <p className="my-4">
              ...
              <p className="my-4">
                ...
                <a href={`https://www.imdb.com/title/${movie.imdb_id}`} target="_blanlk" > {movie.imdb_id} </a>
              </p>
